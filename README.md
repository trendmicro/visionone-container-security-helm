...
If you want to install a specific version you can use the archive link for the tagged release. For example, to install Trend Micro Vision One Container Security helm chart version 3.4.2, run the following command:
...
```sh
  helm install \
    ...
    --create-namespace \
    trendmicro \
    https://github.com/trendmicro/visionone-container-security-helm/archive/3.4.2.tar.gz
```
